...
public class MyFollowAdapter extends XRecyclerView.Adapter<MyFollowAdapter.livenumViewHolder> {
    ...
    public MyFollowAdapter(Context context, List<MyFansBean> mList) {
    ...
    public livenumViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.follow_item, parent, false);
    ...
    private MyFollowAdapter.OnItemSetFollowClickListener onItemSetFollowClickListener;
    private MyFollowAdapter.OnItemClickListener onItemClickListener;

    //对外提供一个监听的方法
    public void setOnItemClickListener(MyFollowAdapter.OnItemClickListener onItemClickListener) {
        this.onItemClickListener = onItemClickListener;
    }

    public void setOnItemSetFollowClickListener(MyFollowAdapter.OnItemSetFollowClickListener onItemClickListener) {
